...
//
//     $(function(){
//       let directingStills = [...$('.directing-gallery .blocks-gallery-item')];
//       console.log(directingStills);
//     })
//
//
//
...
$(document).ready(function() {
    ...
    // directing gifs
    // $(function(){
    //   let directingItems = [...$('.directing-gallery .blocks-gallery-item img')];
    //   let directingStills = [];
    //   let directingGifs = [];
    //   console.log(directingItems);
    //   for (var i = 0; i < directingItems.length; i+=2) {
    //     directingStills.push($(directingItems[i]));
    //     directingGifs.push($(directingItems[i+1]));
    //     $(directingItems[i+1]).css('display', 'none');
    //   }
    //   console.log(directingStills);
    //   console.log(directingGifs);
    //
    //   for (let i = 0; i < directingGifs.length; i++) {
    //     console.log($(directingStills[i]));
    //
    //     $(directingStills[i]).hover(function() {
    //       console.log(directingStills[i].attr('src'));
    //       console.log(directingGifs[i].attr('src'));
    //       directingStills[i].attr('src', 'apple');
    //       // directingStills[i].attr('src', directingGifs[i].attr('src'));
    //       // directingItems[i].attr('src', directingGifs[i].attr('src'));
    //       // directingStills[i].attr('srcset', directingGifs[i].attr('srcset'))
    //       // change URL
    //       // $(`${directingStills[i]}`).attr('src', $(directingGifs[i]).attr('src'));
    //
    //     }, function() {
    //       // directingGifs[i].attr('src', directingStills[i].attr('src'));
    //
    //     })
    //   }
    // });
